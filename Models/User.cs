...
public class User  // Declara la clase User que representa el modelo de usuario en la aplicación.
{
    ...
    public required string Name { get; set; } = string.Empty;  // Propiedad Name que almacena el nombre del usuario.
    ...
    public required string Email { get; set; }  // Propiedad Email que almacena el correo electrónico del usuario.

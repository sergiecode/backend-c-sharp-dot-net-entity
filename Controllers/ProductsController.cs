...
namespace BackendUsuarios.Controllers
{
    ...
    [Authorize]
    public class ProductsController : BaseController<Product, ProductCreateDto, ProductUpdateDto>
    {
        ...
        public async Task<IActionResult> CreateProduct([FromBody] ProductCreateDto productDto)
        {
            ...
            {
                return HandleException(ex, "An error occurred while creating the product.");
            }
        }
